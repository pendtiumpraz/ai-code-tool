  ...
  menu: [
    {
      ...
      icon: 'search',
      submenu: [
        { id: 'vuln-scan', label: 'Vulnerability Assessment', icon: 'bug', prompt: 'Perform vulnerability assessment on target: ' },
        { id: 'pentest', label: 'Penetration Test Plan', icon: 'target', prompt: 'Create penetration test plan for: ' },
        { id: 'code-review', label: 'Security Code Review', icon: 'code', prompt: 'Review this code for security vulnerabilities (OWASP Top 10): ' },
        { id: 'config-audit', label: 'Configuration Audit', icon: 'settings', prompt: 'Audit security configuration for: ' },
        { id: 'network-scan', label: 'Network Security Scan', icon: 'wifi', prompt: 'Create network security scan plan for: ' },
        { id: 'api-security', label: 'API Security Test', icon: 'server', prompt: 'Perform API security assessment for: ' },
      ],
    },
    {
      id: 'redteam',
      ...
      icon: 'crosshair',
      submenu: [
        { id: 'recon', label: 'Reconnaissance (OSINT)', icon: 'eye', prompt: 'Perform OSINT reconnaissance on target: ' },
        { id: 'social-eng', label: 'Social Engineering', icon: 'users', prompt: 'Create social engineering scenario for security awareness training: ' },
        { id: 'phishing', label: 'Phishing Simulation', icon: 'mail', prompt: 'Design phishing awareness campaign template for: ' },
        { id: 'exploit-dev', label: 'Exploit Analysis', icon: 'terminal', prompt: 'Analyze exploit technique and create detection rules for: ' },
        { id: 'post-exploit', label: 'Post-Exploitation', icon: 'key', prompt: 'Explain post-exploitation techniques and defenses for: ' },
        { id: 'report', label: 'Red Team Report', icon: 'file-text', prompt: 'Generate red team assessment report template for: ' },
      ],
    },
    {
      id: 'blueteam',
      ...
      icon: 'shield',
      submenu: [
        { id: 'log-analysis', label: 'Log Analysis', icon: 'file-search', prompt: 'Analyze these logs for security incidents: ' },
        { id: 'threat-hunt', label: 'Threat Hunting', icon: 'search', prompt: 'Create threat hunting hypothesis for: ' },
        { id: 'incident-response', label: 'Incident Response', icon: 'alert-triangle', prompt: 'Create incident response playbook for: ' },
        { id: 'forensics', label: 'Digital Forensics', icon: 'hard-drive', prompt: 'Guide digital forensics investigation for: ' },
        { id: 'malware-analysis', label: 'Malware Analysis', icon: 'bug', prompt: 'Analyze malware behavior and create detection signatures for: ' },
        { id: 'ioc-extraction', label: 'IOC Extraction', icon: 'database', prompt: 'Extract indicators of compromise (IOCs) from: ' },
      ],
    },
    {
      id: 'compliance',
      ...
      submenu: [
        { id: 'pci-dss', label: 'PCI-DSS Assessment', icon: 'credit-card', prompt: 'Perform PCI-DSS compliance gap analysis for: ' },
        { id: 'hipaa', label: 'HIPAA Compliance', icon: 'heart', prompt: 'Assess HIPAA security requirements for: ' },
        { id: 'soc2', label: 'SOC 2 Audit', icon: 'shield', prompt: 'Evaluate SOC 2 Type II readiness for: ' },
        { id: 'iso27001', label: 'ISO 27001', icon: 'award', prompt: 'Conduct ISO 27001 gap analysis for: ' },
        { id: 'gdpr', label: 'GDPR Assessment', icon: 'lock', prompt: 'Assess GDPR compliance requirements for: ' },
        { id: 'nist', label: 'NIST Framework', icon: 'layers', prompt: 'Map security controls to NIST Cybersecurity Framework for: ' },
      ],
    },
    {
      id: 'reports',
      ...
      icon: 'file-text',
      submenu: [
        { id: 'executive-summary', label: 'Executive Summary', icon: 'briefcase', prompt: 'Generate executive summary report for security assessment of: ' },
        { id: 'technical-report', label: 'Technical Report', icon: 'code', prompt: 'Create detailed technical security report for: ' },
        { id: 'remediation-plan', label: 'Remediation Plan', icon: 'check-circle', prompt: 'Create prioritized remediation plan for vulnerabilities found in: ' },
        { id: 'risk-matrix', label: 'Risk Matrix', icon: 'grid', prompt: 'Generate risk assessment matrix for: ' },
      ],
    },
  ],
